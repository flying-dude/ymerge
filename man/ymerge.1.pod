...
Override "--yes" to enable confirmation at decision points again. Default is to
always "--ask", if neither flag is specified.
...
Only list what would be done without actually doing anything.
